        ...
        <div class="mx-auto" style="width: 75%;">
            ...
            <form method="POST" action="/updateCarClient">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-sm-10">
                        <input name="rf_number"

                               class="form-control @if (session()->get('errorRfNumber') !== null)  is-invalid @endif  "
                               placeholder="Введите Гос Номер автомобиля"
                               value="{{$car->rf_number}}" aria-describedby="validationServer03Feedback" required>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-sm-10">
                        <input name="fio" class="form-control" placeholder="Введите ФИО клиента"
                               value="{{$client->fio}}" minlength="3" maxlength="255" id="fio-required" required>
                    </div>
                </div>
                <div class="row mt-3">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-sm-10">
                        <input name="number" class="form-control @if (session()->get('errorNumber') !== null)  is-invalid @endif "
                               ...
                               id="number-required" value="{{$client->number}}" aria-describedby="validationServer03Feedback" required>
                        <div id="validationServer03Feedback" class="invalid-feedback">
